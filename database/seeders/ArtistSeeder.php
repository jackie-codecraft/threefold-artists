...
class ArtistSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($artists as $data) {
            ...
            $disciplineSlugs = $data['discipline_slugs'];
            unset($data['discipline_slugs']);
            ...
            $artist->disciplines()->sync(Discipline::query()->whereIn('slug', $disciplineSlugs)->pluck('id')->all());

...
<head>
    ...
    <title>Re: {{ $contactMessage->subject ?: 'Your message' }}</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="color: #1A1A1A; font-size: 16px; line-height: 1.7;">
                            ...
                            <p style="margin: 0 0 24px;">Thank you for reaching out to Threefold Artists. Here is our response to your inquiry:</p>
                            ...
                            <p style="margin: 0 0 8px; color: #999999; font-size: 13px; text-transform: uppercase; letter-spacing: 1px;">Your Original Message</p>
                            @if($contactMessage->subject)
                            <p style="margin: 0 0 8px; color: #666666; font-size: 14px;"><strong>Subject:</strong> {{ $contactMessage->subject }}</p>
                            @endif
                            <p style="margin: 0; color: #666666; font-size: 14px;">{{ $contactMessage->message }}</p>
                        </td>
                    </tr>
                </table>
            </td>

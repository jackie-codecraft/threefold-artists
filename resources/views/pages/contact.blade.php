                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-full bg-curtain-red/10 flex items-center justify-center shrink-0 mt-1">
                                <svg class="w-5 h-5 text-curtain-red" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            </div>
                            <div>
                                <h3 class="font-semibold text-theatre-black">Email</h3>
                                <a href="mailto:hello@threefoldartists.org" class="text-curtain-red hover:underline">hello@threefoldartists.org</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex gap-3 mt-2">
                                    <a href="#" class="text-gray-500 hover:text-curtain-red">Facebook</a>
                                    <a href="#" class="text-gray-500 hover:text-curtain-red">Instagram</a>
                                    <a href="#" class="text-gray-500 hover:text-curtain-red">YouTube</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="message" id="message" rows="5" required
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-curtain-red focus:ring-curtain-red">{{ old('message') }}</textarea>
                                @error('message') <p class="text-red-600 text-sm mt-1">{{ $message }}</p> @enderror
                            </div>

                            <button type="submit" class="inline-flex items-center justify-center px-8 py-3 rounded-full bg-curtain-red text-white font-bold hover:bg-curtain-red-light transition-colors shadow-lg">
                                Send Message
                            </button>
                        </form>
                    </div>

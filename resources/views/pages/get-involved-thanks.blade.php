<x-layouts.app title="Thank You" metaDescription="Your artist application has been submitted.">
    <section class="py-32 sm:py-40">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="font-display text-4xl sm:text-5xl font-light text-theatre-black mb-6">Application Received</h1>
            <p class="text-lg text-gray-500 mb-12">Thank you for sharing your artistry with Threefold Artists. We’ve received your application and will review it with care. We’ll be in touch soon.</p>

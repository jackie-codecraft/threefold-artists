<x-layouts.app title="Thank You" metaDescription="Your artist application has been submitted.">
    <section class="py-24">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="font-display text-4xl font-bold text-theatre-black mb-4">Welcome Aboard!</h1>
            <p class="text-xl text-gray-600 mb-8">Thank you for your interest in volunteering with Threefold Artists. We will review your application and be in touch soon.</p>

            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-6">
                    <div class="w-14 h-14 mx-auto mb-4 rounded-full bg-stage-gold/10 flex items-center justify-center">
                        <svg class="w-7 h-7 text-stage-gold-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                    </div>
                ...
                <form action="{{ route('get-involved.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="experience" id="experience" rows="3"
                            ...
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-stage-gold focus:ring-stage-gold">{{ old('experience') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="bio" id="bio" rows="3"
                            ...
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-stage-gold focus:ring-stage-gold">{{ old('bio') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="availability" id="availability" rows="2"
                            ...
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-stage-gold focus:ring-stage-gold">{{ old('availability') }}</textarea>
                    </div>

            ...
            @else
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16">
                    ...
                    <a href="{{ route('artists.show', $artist) }}" class="block group text-center">
                        <div class="w-32 h-32 mx-auto mb-6 bg-linen flex items-center justify-center overflow-hidden">
                        ...
                        <h3 class="font-display text-xl font-normal text-theatre-black mb-1 group-hover:text-stage-gold-dark transition-colors">{{ $artist->name }}</h3>

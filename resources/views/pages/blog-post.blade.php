    ...
    <article>
        ...
        <section class="py-16">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="prose prose-lg max-w-none prose-headings:font-display prose-headings:text-theatre-black prose-a:text-curtain-red">
                    {!! $post->content !!}
                </div>

                <div class="mt-12 pt-8 border-t border-linen-dark">
                    <a href="{{ route('blog') }}" class="inline-flex items-center text-curtain-red font-semibold hover:underline">
